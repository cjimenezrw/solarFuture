...
;(function(root, factory) {
    ...
    function Dropify(element, options) {
        ...
        var defaults = {
            ...
            messages: {
                'default': 'Arrastre y Suelte o Haga Clic Aquí',
                'replace': 'Arrastre y Suelte o haga clic aquí para reemplazar',
                'remove':  'Remover',
                'error':   'Ooops, Lamentablemente Algo Salío Mal.'
            },
            error: {
                'fileSize': 'El tamaño del archivo es demasiado grande, máximo ({{ value }}).',
                'minWidth': 'El ancho de la imagen es muy pequeña ({{ value }}}px minimo).',
                'maxWidth': 'El ancho de la imagen es muy grande ({{ value }}}px máximo).',
                'minHeight': 'La altura de la imagen es muy pequeña ({{ value }}}px minimo).',
                ...
                'fileExtension': 'El archivo no está permitido, sólo ({{ value }}).'
            },
            tpl: {
