...
<div class="slidePanel-footer margin-bottom-20 margin-top-20 pull-right">
    <?php
    ...
    ?>
    <button type="button" class="btn btn-default" onclick="core.closePanelModule();">Cerrar </button>
  </div>
</div>