...
Class Coco_deta_Controller Extends Admi_Model {
    ...
    public function consultar() {
         	$this->admi['skComprobanteCFDI'] = $_GET['p1'];
            ...
            $this->data['comprobantes_servicios'] = parent::consultar_comprobantes_servicios();
