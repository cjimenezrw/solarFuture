                ...
                <div class="row row-lg">
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="form-group">
                            ...
                            <label><?php echo (isset($result['banco'])) ? ($result['banco']) : ''; ?></label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="form-group">
                            ...
                            <label><?php echo (isset($result['divisa'])) ? ($result['divisa']) : ''; ?></label>
                        </div>
                    </div>

                    <div class="col-md-4 col-lg-4">
                        <div class="form-group">
                            <h4 class="example-title">EMPRESA TITULAR:</h4>
                            <label><?php echo (isset($result['empresaResponsable'])) ? ($result['empresaResponsable']) : ''; ?></label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="form-group">
                            <h4 class="example-title">TITULAR:</h4>
                            <label><?php echo (isset($result['sTitular'])) ? ($result['sTitular']) : ''; ?></label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="form-group">
                            ...
                            <label><?php echo (isset($result['sNumeroCuenta'])) ? ($result['sNumeroCuenta']) : ''; ?></label>
                        </div>
                    </div>
                    
                    <div class="col-md-4 col-lg-4">
                        <div class="form-group">
                            <h4 class="example-title">CLABE INTERBANCARIA:</h4>
                            <label><?php echo (isset($result['sClabeInterbancaria'])) ? ($result['sClabeInterbancaria']) : ''; ?></label>
                        </div>
                    </div>
                    
                    <div class="col-md-4 col-lg-4">
                        <div class="form-group">
                            <h4 class="example-title">CUENTA CONTABLE:</h4>
                            <label><?php echo (isset($result['sCuentaContable'])) ? ($result['sCuentaContable']) : ''; ?></label>
                        </div>
                    </div>
