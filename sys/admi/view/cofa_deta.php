	...
	<div class="col-md-12">
		...
		<div class="panel-body container-fluid same-heigth">
			...
			<div class="col-md-12 col-lg-12">
				...
				<p><?php echo (isset($result['empresaFacturar'])) ? $result['empresaFacturar'] : 'N/D'; ?> </p>
			    </div>
			</div>
			...
			<div class="col-md-6 col-lg-4">
				...
				<p><?php echo (!empty($result['dFechaFactura']) ? date('d/m/Y', strtotime($result['dFechaFactura'])) : 'N/D'); ?> </p>
			    </div>
			</div>
			<div class="col-md-12">
			...
			<table class="table text-right">
				...
				<?php
				$i = 1;
				if (isset($data['facturas_servicios'])) {
				    foreach ($data['facturas_servicios'] AS $servicios) {
					?>
					<tr>
    		...
    		<div class="panel-body container-fluid same-heigth">
    			...
    			<div class="col-md-12">
    				...
    				<div class="form-group">
    				    ...
    				    <p><?php echo (!empty($data['datosFactura']['dFechaFacturacion']) ? date('d/m/Y H:i:s', strtotime($data['datosFactura']['dFechaFacturacion'])) : 'N/D'); ?></p>
    				</div>
    			    </div>
