    ...
    <table style="font-size:10px;" class="col-md-12">
        ...
        <tr>
            <th class="col-md-12" colspan="2" style="text-align:left;text-transform:uppercase;background-color: #FFFFFF; color: #000000;font-weight: normal;word-break: break-all;">
                <?php echo isset($data['datos']['empresaCliente']) ? substr($data['datos']['empresaCliente'],0,59) : ''; ?>
            </th>
        </tr>
        <tr>
        ...
        <tr>
            <th class="col-md-12" colspan="2" style="text-align:left;text-transform:uppercase;background-color: #FFFFFF; color: #000000;font-weight: normal;word-break: break-all;">
                <?php echo !empty($data['datos']['sAsunto']) ? substr($data['datos']['sAsunto'],0,59) : '-'; ?>
            </th>
        </tr>
        <tr>
...
<div class="col-md-6 col-md-offset-1">
    <table style="font-size:10px;" class="col-md-12">
        ...
        <tr>
            ...
            <th class="col-md-6" style="text-align:left;text-transform:uppercase;background-color: #cecece; color: #000000;font-weight: bold;">FECHA DE CITA</th>
        </tr>
        <tr>
            <th class="col-md-6" style="text-align:left;text-transform:uppercase;background-color: #FFFFFF; color: #000000;font-weight: normal;">
            ...
            <th class="col-md-6" style="text-align:left;text-transform:uppercase;background-color: #FFFFFF; color: #000000;font-weight: normal;">
                <?php echo !empty($data['datos']['dFechaCita']) ? $this->obtenerFechaEnLetra($data['datos']['dFechaCita']).' A LAS '.$data['datos']['tHoraInicio'] : '-'; ?>
            </th>
        </tr>
        <tr>
...
<div class="col-md-12 clearfix">
    <table style="font-size:10px;" class="col-md-12">
        <tr>
            <th class="col-md-12" style="text-align:center;background-color: #cecece; color: #000000;font-weight: bold;">DATOS GENERALES</th>
        </tr>
        <tr>
...
<div class="col-md-12">
    <table style="font-size:9px;" class="col-md-12">
        ...
        <?php
            if(isset($data['serviciosCita']) && count(($data['serviciosCita'])) > 0){
                $cont = 1;
                $bg_flag = 0;
        ...
        <tr>
            ...
            <td style="text-align:right;text-transform:uppercase;background-color:#<?php echo $bg[$bg_flag]; ?>;">$<?php echo (isset($row['fImporte']) ? number_format($row['fImporte'],2) : '0.00');?></td>
