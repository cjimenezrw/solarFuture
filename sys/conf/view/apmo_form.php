...
<form class="form-horizontal" id="core-guardar" method="post"  enctype="multipart/form-data">
    <input type="hidden" name="skAplicacionVieja"  id="skAplicacionVieja" value="<?php echo (isset($result['skAplicacion'])) ? $result['skAplicacion'] : '' ; ?>">
    <div class="form-group col-md-12">
        <label class="col-md-2 control-label"><b>C&oacute;digo:</b> </label>
        <div class="col-md-3">
            <input class="form-control" maxlength="4" <?php if(isset($result['skAplicacion'])){ ?>disabled="disabled"<?php }//ENDIF ?>  name="skAplicacion" value="<?php echo (isset($result['skAplicacion'])) ? utf8_encode($result['skAplicacion']) : '' ; ?>" placeholder="C&oacute;digo" autocomplete="off" type="text">
        </div>
    </div>
    <div class="form-group col-md-12">
        <div class="col-md-2">
...
<script type="text/javascript">
    core.formValidaciones.fields = conf.apmo_form.validaciones;
