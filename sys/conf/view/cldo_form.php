...
<form class="form-horizontal" id="core-guardar" method="post"  enctype="multipart/form-data">
  <input name="skClaveDocumento" value="<?php   echo (isset($result['skClaveDocumento'])) ? $result['skClaveDocumento'] : '';   ?>" type="hidden">

      <div class="form-group col-md-12">
        <label class="col-md-2 control-label"><b>Clave:</b> </label>
        <div class="col-md-3 form-group">
            <input class="form-control"   name="sClave" value="<?php   echo (isset($result['sClave'])) ? $result['sClave'] : '';   ?>" placeholder="clave" autocomplete="off" type="text">
        </div>
      </div>
    <div class="form-group col-md-12">
...
<script type="text/javascript">
    core.formValidaciones.fields = conf.cldo_form.validations;
