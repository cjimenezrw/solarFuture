...
conf.rech_form = {};
conf.rech_form.validaciones = {};

conf.rech_inde = {};
conf.rech_inde.dataTableConf = {
    'serverSide': true,
    'ajax': {
...
conf.ardo_inde.dataTableConf = {
    ...
    'columns': [
        {'title': 'E', 'filterT': 'Estatus', 'data': 'estatus', 'dataType': 'string'},
        {'title': 'CODIGO', 'data': 'skArchivoDocumento', 'dataType': 'string'},
        {'title': 'Nombre', 'data': 'sNombre', 'dataType': 'string'},
        {'title': 'Fecha Creación', 'data': 'dFechaCreacion', 'dataType': 'date'}
    ],
    'axn': 'consultar',
...
conf.cldo_form = {};
conf.cldo_form.validaciones = {};


conf.cldo_inde = {};
conf.cldo_inde.dataTableConf = {
    'serverSide': true,
    'ajax': {
        'url': window.location.href,
        'type': 'POST',
...
conf.came_form = {};
conf.came_form.validaciones = {};



conf.came_inde = {};
conf.came_inde.dataTableConf = {
    'serverSide': true,
    'ajax': {
        'url': window.location.href,
        'type': 'POST',
...
conf.modn_inde.dataTableConf = {
    ...
    'order': [[9, "desc"]],
    'columns': [
        {'title': 'E', 'data': 'estatus', 'dataType': 'string', 'filterT': 'Estatus','tooltip': 'Estatus'},
        {'title': 'skModulo', 'data': 'skModulo', 'dataType': 'string'},
        {'title': 'Módulo', 'data': 'modulo', 'dataType': 'string'},
        {'title': 'Empresa', 'data': 'empresa', 'dataType': 'string'},
        {'title': 'RFC', 'data': 'sRFC', 'dataType': 'string'},
        {'title': 'Aduana', 'data': 'sAduana', 'dataType': 'string'},
        {'title': 'Responsable', 'data': 'responsable', 'dataType': 'string'},
        {'title': 'Desarrollador', 'data': 'developer', 'dataType': 'string'},
        {'title': 'Fecha Implementación', 'data': 'dFechaImplementacion', 'dataType': 'date'},
        {'title': 'Fecha Creación', 'data': 'dFechaCreacion', 'dataType': 'date'},
...
/*
 * Módulo tpno-inde (consulta-tiposNotificacion)
 */
conf.tpno_inde = {};
conf.tpno_inde.dataTableConf = {
    'serverSide': true,
    'ajax': {
        'url': window.location.href,
        'type': 'POST',
        'data': function (data) {
            data.axn = 'getTiposNotificacion';
            data.filters = core.dataFilterSend;
            data.generarExcel = core.generarExcel;
        }
    },
    ...
    'columns': [
        ...
        {'title': 'Código', 'data': 'skTipoNotificacion', 'dataType': 'string'},
        {'title': 'Nombre', 'data': 'sNombre', 'dataType': 'string'},
        {'title': 'Descripción', 'data': 'sDescripcion', 'dataType': 'string'},
        {'title': 'Fecha Creación', 'data': 'dFechaCreacion', 'dataType': 'date'}
    ],
    'axn': 'getTiposNotificacion',
    "drawCallback": function () {
        core.dataTable.contextMenuCore(true);
...
conf.cuen_form = {};
conf.cuen_form.validaciones = {

};
conf.tpno_form = {};
conf.tpno_form.validaciones = {
    skTipoNotificacion: {
        threshold: 6,
        validators: {
            notEmpty: {
...
/*
 *
 * Módulo de consulta de grupos de usuarios (grus-inde)
 *
 */

conf.grus_inde = {};

conf.grus_inde.dataTableConf = {
    'serverSide': true,
    'ajax': {
        'url': window.location.href,
        'type': 'POST',
    ...
    'axn': 'consultar',
    'rowId': 'skGrupoUsuario',
    'columns': [
        {'title': 'contextM', 'tooltip': 'Estatus', 'data': 'menuEmergente', 'dataType': 'hidde', 'hiddenF': true, 'excluirExcel': true},
        {'title': 'E', 'filterT': 'Estatus', 'data': 'estatus', 'dataType': 'string'},
        {'title': 'Nombre', 'data': 'sNombre', 'dataType': 'string'},
        {'title': 'Descripción', 'data': 'sDescripcion', 'dataType': 'string'},
        {'title': 'Responsable', 'data': 'responsable', 'dataType': 'string'},
...
/*
 *
 * Módulo de agregar grupos de usuarios (grus-form)
 *
 */

conf.grus_form = {};

conf.grus_form.validaciones = {
    sNombre: {
        validators: {
            notEmpty: {
                message: 'El nombre es requerido.'
...
conf.sevi_inde = {};
conf.sevi_inde.dataTableConf = {
    'serverSide': true,
    'ajax': {
        'url': window.location.href,
        'type': 'POST',
        'data': function (data) {
            data.axn = 'getServidoresVinculados';
            data.filters = core.dataFilterSend;
            data.generarExcel = core.generarExcel;
        }
    },
    ...
    'columns': [
        ...
        {'title': 'E', 'filterT': 'Estatus', 'data': 'skEstatus', 'dataType': 'string'},
        {'title': 'Código', 'data': 'skServidorVinculado', 'dataType': 'string'},
        {'title': 'Nombre', 'data': 'sNombre', 'dataType': 'string'},
        {'title': 'IP', 'data': 'sIP', 'dataType': 'string'},
        {'title': 'Usuario', 'data': 'sUsuario', 'dataType': 'string'},
        {'title': 'Password', 'data': 'sPassword', 'dataType': 'string'},
        {'title': 'BDA', 'data': 'sBDA', 'dataType': 'string'},
        {'title': 'Fecha Creación', 'data': 'dFechaCreacion', 'dataType': 'date'},
        {'title': 'Ruta de Vinculación', 'data': 'sVinculacion', 'dataType': 'string'}
    ],
    'axn': 'getServidoresVinculados',
    "drawCallback": function () {
        core.dataTable.contextMenuCore(true);
...
conf.sevi_form.validaciones = {
    ...
    iPuerto: {
        validators: {
            notEmpty: {
                message: 'Debe especificar un puerto'
            }
        }
    },
    sIP: {
...
/*
 * Módulo depa-inde (departamentos)
 */
conf.depa_inde = {};

conf.depa_inde.dataTableConf = {
    'serverSide': true,
    'ajax': {
        'url': window.location.href,
        'type': 'POST',
    ...
    'order': [[2, "desc"]],
    'rowId': 'skDepartamento',
    'columns': [
        //{'title': 'contextM', 'tooltip': 'Estatus', 'data': 'menuEmergente', 'dataType': 'hidde', 'hiddenF':'', 'excluirExcel': true},
        {'title': 'E', 'tooltip': 'Estatus', 'data': 'skEstatus', 'dataType': 'string'},
        {'title': 'Código', 'data': 'skDepartamento', 'dataType': 'string'},
        {'title': 'Nombre', 'data': 'sNombre', 'dataType': 'string'},
        {'title': 'Area', 'data': 'skArea', 'dataType': 'string'},
        {'title': 'Fecha', 'data': 'dFechaCreacion', 'dataType': 'date'}
...
/*
 * Módulo area-inde (areas)
 */
conf.area_inde = {};

conf.area_inde.dataTableConf = {
    'serverSide': true,
    'ajax': {
        'url': window.location.href,
        'type': 'POST',
    ...
    'columns': [
        {'title': 'E', 'tooltip': 'Estatus', 'data': 'skEstatus', 'dataType': 'string'},
        {'title': 'Código', 'data': 'skArea', 'dataType': 'string'},
        {'title': 'Area', 'data': 'sNombre', 'dataType': 'string'},
        {'title': 'Fecha Creación', 'data': 'dFechaCreacion', 'dataType': 'date'}
...
conf.vasi_form.validaciones = {
    ...
    skVariableTipo: {
        validators: {
            notEmpty: {
                message: 'Seleccione un Tipo de Variable'
            }
        }
    },
    sNombre: {
...
conf.tvar_inde.dataTableConf = {
    'serverSide': true,
    'ajax': {
        'url': window.location.href,
        'type': 'POST',
        'data': function (data) {
            data.axn = 'getTiposVariables';
            data.filters = core.dataFilterSend;
            data.generarExcel = core.generarExcel;
        }
    },
    'order': [[2, "desc"]],
    'rowId': 'skVariableTipo',
    'columns': [
        {
            'title': 'contextM',
            'tooltip': 'Estatus',
        ...
        {'title': 'E', 'filterT': 'skEstatus', 'data': 'skEstatus', 'dataType': 'string'},
        {'title': 'Codigo', 'data': 'skVariableTipo', 'dataType': 'string'},
        {'title': 'Nombre', 'data': 'sNombre', 'dataType': 'string'}
    ],
    'axn': 'getTiposVariables',
    "drawCallback": function () {
        core.dataTable.contextMenuCore(true);
        core.dataTable.changeColumnColor(2, 'success');
        $('[data-toggle="tooltip"]').tooltip();
...
conf.apmo_inde.dataTableConf = {
    'serverSide': true,
    'ajax': {
        'url': window.location.href,
        'type': 'POST',
        'data': function (data) {
            data.axn = 'getAplicaciones';
            data.filters = core.dataFilterSend;
            data.generarExcel = core.generarExcel;
        }
    },
    ...
    'columns': [
        {'title': 'E', 'tooltip': 'Estatus', 'data': 'skEstatus', 'dataType': 'string'},
        {'title': 'Código', 'data': 'skAplicacion', 'dataType': 'string'},
        {'title': 'Aplicacion', 'data': 'sNombre', 'dataType': 'string'}
...
/*
 * Módulo apus-deta (Aplicaciones Usuarios)
 */
conf.apus_deta = {};

conf.apus_deta.dataTableConf = {
    'serverSide': true,
    'ajax': {
        'url': window.location.href,
        'type': 'POST',
        'data': function (data) {
            data.axn = 'getAppsUsers';
            data.filters = core.dataFilterSend;
            data.generarExcel = core.generarExcel;
        }
    },
    'order': [[1, "desc"]],
    'columns': [
        {'title': 'Usuario', 'data': 'sNombre', 'dataType': 'string'},
        {'title': 'Fecha de Sesion', 'data': 'dFechaCreacion', 'dataType': 'date'},
        {'title': 'Aplicacion', 'data': 'skAplicacion', 'dataType': 'string'},
        {'title': 'Modelo', 'data': 'sModelo', 'dataType': 'string'},
        {'title': 'OS Version', 'data': 'sOsVersion', 'dataType': 'string'},
        {'title': 'App Version', 'data': 'sVersionApp', 'dataType': 'string'},
        {'title': 'Operadora', 'data': 'sOperadora', 'dataType': 'string'},
        {'title': 'Dispositivo ID', 'data': 'sIdDispositivo', 'dataType': 'string'},
        {'title': 'Token Dispositivo', 'data': 'skDispositivoToken', 'dataType': 'string'}
...
conf.meno_inde.dataTableConf = {
    ...
    'ajax': {
        ...
        'type': 'POST',
        'data': function (data) {
            data.axn = 'getMensajesNotificacion';
            data.filters = core.dataFilterSend;
            data.generarExcel = core.generarExcel;
        }
    },
...
conf.grno_inde.dataTableConf = {
    ...
    'axn': 'consultar',
    'rowId': 'skGrupoNotificacion',
    'columns': [
        {'title': 'E', 'filterT': 'Estatus', 'data': 'estatus', 'dataType': 'string'},
        {'title': 'Nombre', 'data': 'sNombre', 'dataType': 'string'},
        {'title': 'Fecha de creación', 'data': 'dFechaCreacion', 'dataType': 'date'},
        {'title': 'Descripción', 'data': 'sDescripcion', 'dataType': 'string'},
        {'title': 'Empresa Propietaria', 'data': 'empresaPropietaria', 'dataType': 'string'},
...
conf.cage_inde.dataTableConf = {
    ...
    'order': [[4, "desc"]],
    'columns': [
        {'title': 'E', 'data': 'skEstatus', 'dataType': 'string', 'filterT': 'Estatus'},
...
conf.caba_inde = {};
conf.caba_inde.dataTableConf = {
    'serverSide': true,
    'ajax': {
        'url': window.location.href,
        'type': 'POST',
        'data': function (data) {
            data.axn = 'getCatalogosBancos';
            data.filters = core.dataFilterSend;
            data.generarExcel = core.generarExcel;
        }
    },
...
conf.cuen_inde = {};
conf.cuen_inde.dataTableConf = {
    'serverSide': true,
    'ajax': {
        'url': window.location.href,
        'type': 'POST',
        'data': function (data) {
            data.axn = 'getCatalogosCuentas';
            data.filters = core.dataFilterSend;
            data.generarExcel = core.generarExcel;
        }
    },
    ...
    'columns': [
        {'title': 'E', 'data': 'skEstatus', 'dataType': 'string', 'filterT': 'Estatus'},
        {'title': 'No de cuenta', 'data': 'sNombre', 'dataType': 'string'},
        {'title': 'Descripcion', 'data': 'sDescripcionCuenta', 'dataType': 'string'},
        {'title': 'Banco', 'data': 'sBanco', 'dataType': 'string'},
        {'title': 'Fecha Creación', 'data': 'dFechaCreacion', 'dataType': 'date'}

    ],
    'axn': 'getCatalogosCuentas',
    "drawCallback": function () {
        core.dataTable.contextMenuCore(true);
        core.dataTable.changeColumnColor(1, 'success');
        $('[data-toggle="tooltip"]').tooltip();
...
conf.tarj_inde = {};
conf.tarj_inde.dataTableConf = {
    'serverSide': true,
    'ajax': {
        'url': window.location.href,
        'type': 'POST',
        'data': function (data) {
            data.axn = 'getCatalogosTarjetas';
            data.filters = core.dataFilterSend;
            data.generarExcel = core.generarExcel;
        }
    },
...
/*
 *
 * Módulo de agregar grupos de usuarios (grno-form)
 *
 */

conf.grno_form = {};

conf.grno_form.validaciones = {
    sNombre: {
        validators: {
            notEmpty: {
                message: 'El nombre es requerido.'
