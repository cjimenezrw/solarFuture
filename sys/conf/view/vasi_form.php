...
<form class="form-horizontal" id="core-guardar" method="post"  enctype="multipart/form-data">
  ...
  <div class=" col-md-12">
    ...
    <div class="form-group col-sm-3">
      ...
      <select  name="skVariableTipo" class="form-control">
    ...
    <div class="form-group col-sm-3">
      ...
      <div class="col-md-12">
              ...
              <div class="form-group col-md-3">
                  <input class="form-control" name="sValor"
                         value="<?php echo (isset($result['sValor'])) ? $result['sValor'] : ''; ?>"
...
<script type="text/javascript">
    core.formValidaciones.fields = conf.vasi_form.validaciones;
