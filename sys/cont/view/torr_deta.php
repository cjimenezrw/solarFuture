        ...
        <div class="row">
            ...
            <div role="alert" class="alert dark alert-danger alert-icon alert-dismissible animated slideInDown">
                <p class="font-size-20"><b><i class="icon wb-bell" aria-hidden="true"></i> TORRE CANCELADA</b></p>
                <p><b><?php echo (!empty($data['datos']['usuarioCancelacion']) ? $data['datos']['usuarioCancelacion'] : ''); ?></b> canceló la torre por la siguiente razón: <b><?php echo (!empty($data['datos']['sObservacionesCancelacion']) ? $data['datos']['sObservacionesCancelacion'] : '-'); ?></b></p>
                    ...
                    <div class="row row-lg">
                        <div class="col-lg-12 col-md-12">
                            ...
                            <tbody class="tbody_searchable">
                                <?php 
                                if(isset($data['_get_accessPoint']) && !empty($data['_get_accessPoint']) && is_array($data['_get_accessPoint'])){
                                    $i = 1;
                                    foreach($data['_get_accessPoint'] AS $row) { 
                                ?>
                                    <tr>
                                        <td><?php echo $i; ?></td>
