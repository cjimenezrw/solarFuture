...
<form class="form-horizontal" id="core-guardar" method="post"  enctype="multipart/form-data">
    <input type="hidden" name="skPromotor"  id="skPromotor"
           value="<?php echo (isset($result['skPromotor'])) ? $result['skPromotor'] : ''; ?>">
    ...
    <div class="form-group col-md-12">
        ...
        <label class="col-md-2 control-label"><b>Correo:</b> </label>

        <div class="col-md-3">
            <input class="form-control" name="sCorreo"
                   value="<?php echo (isset($result['sCorreo'])) ? ($result['sCorreo']) : ''; ?>" placeholder="Correo" autocomplete="off" type="text">
        </div>
...
<script type="text/javascript">
    core.formValidaciones.fields = empr.prom_form.validaciones;
