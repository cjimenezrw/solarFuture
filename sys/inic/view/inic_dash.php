...
<div class="row" data-plugin="matchHeight" data-by-row="true">
    ...
    <div class="col-sm-12 col-xs-12 col-md-12">
        ...
        <div class="col-sm-3 col-xs-12 info-panel">
            <div class="widget widget-shadow">
                <div class="widget-content bg-white padding-20">
                    ...
                    <span
                        class="margin-left-15 font-weight-400">Usuarios</span>

                    <div class="content-text text-center margin-bottom-0">
                        <i class="text-success icon wb-triangle-up font-size-20">
                        </i>
                        <span
                            class="font-size-30 font-weight-100 count"><?php echo ($result['ventaGeneral']['totalDia'] ? number_format($result['ventaGeneral']['totalDia'],2): '000'); ?></span><br>

                        <p class="blue-grey-400 font-weight-100 margin-0">
        ...
        <div class="col-sm-3 col-xs-12 info-panel">
            <div class="widget widget-shadow">
                <div class="widget-content bg-white padding-20">
                    ...
                    <span
                        class="margin-left-15 font-weight-400">Empresas</span>

                    <div class="content-text text-center margin-bottom-0">
                        <i class="text-success icon wb-triangle-up font-size-20">
                        </i>
                        <span
                            class="font-size-30 font-weight-100 count"><?php echo ($result['caja1']['totalDia'] ? number_format($result['caja1']['totalDia'],2): '000'); ?></span><br>
        ...
        <div class="col-sm-3 col-xs-12 info-panel">
            <div class="widget widget-shadow">
                <div class="widget-content bg-white padding-20">
                    ...
                    <span
                        class="margin-left-15 font-weight-400">Venta Caja 2(Dia)</span>

                    <div class="content-text text-center margin-bottom-0">
                        <i class="text-success icon wb-triangle-up font-size-20">
                        </i>
                        <span
                            class="font-size-30 font-weight-100 count"><?php echo ($result['caja2']['totalDia'] ? number_format($result['caja2']['totalDia'],2): '000'); ?></span><br>
        ...
        <div class="col-sm-3 col-xs-12 info-panel">
            <div class="widget widget-shadow">
                <div class="widget-content bg-white padding-20">
                    ...
                    <span
                        class="margin-left-15 font-weight-400">Venta Caja 3(Dia)</span>

                    <div class="content-text text-center margin-bottom-0">
                        <i class="text-success icon wb-triangle-up font-size-20">
                        </i>
                        <span
                            class="font-size-30 font-weight-100 count"><?php echo ($result['caja3']['totalDia'] ? number_format($result['caja3']['totalDia'],2): '000'); ?></span><br>
