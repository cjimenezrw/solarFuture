    ...
    <div class="table-responsive clearfix" id="conceptos" style="overflow-y:visible;font-size: 10pt;">
            ...
            <table class="table table-striped table-bordered" id="conceptos">
                ...
                <tbody class="searchable" id="conceptos-body">
                        ...
                        <?php
                        if (isset($data['pagosServicios'])){
                            $cont = 1;
                            foreach ($data['pagosServicios'] as $row){ ?>
                            ...
                            <tr <?php echo (!empty($row['TRAIVA']) ? "TRAIVA = '".$row['TRAIVA']."' " : ''); ?> <?php echo (!empty($row['RETIVA']) ? "RETIVA = '".$row['RETIVA']."' " : ''); ?>>
                                ...
                                <td>
                                    <select name="conceptos[<?php echo $cont; ?>][skConcepto]" onchange="datosConcepto(this);" class="skConcepto form-control js-data-example-ajax" data-plugin="select2" data-ajax--cache="true">
                                        <option value="<?php echo (isset($row['skConcepto']) ? $row['skConcepto'] : ''); ?>"><?php echo (isset($row['servicio']) ? $row['servicio'] : ''); ?></option>
                                    </select>
        ...
        $("#skImpuesto").select2({
            ...
            eliminarConcepto = function (obj) {
                    ...
                    $("#concepto-agregar").click(function(event){
                            ...
                            '<td><select name="conceptos[' + cont + '][skConcepto]" onchange="datosConcepto(this);" class="skConcepto form-control js-data-example-ajax" data-plugin="select2" data-ajax--cache="true">  </select></td>'+
