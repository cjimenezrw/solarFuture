...
try {
    ...
    //Recipients
    $mail->setFrom('contacto@lgabogadosmanzanillo.com', 'Mailer');          //This is the email your form sends From
    $mail->addAddress('christianjimenezcjs@gmail.com', 'Christian Jiménez'); // Add a recipient address
