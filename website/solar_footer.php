                        ...
                        <div class="col-lg-2 col-md-2 col-xs-12 col-sm-4">
                            <!-- <div class="wrapper_second_useful wrapper_second_links">
                                ...
                                <ul>
                                    ...
                                    <li><a href="index.html#"><i class="fa fa-angle-right"></i>FAQ </a>
                                    </li>
                                    <li><a href="index.html#"><i class="fa fa-angle-right"></i>awards </a>
                                    </li>
                                    <li><a href="index.html#"><i class="fa fa-angle-right"></i>tstimonials</a>
                                    </li>
