                    ...
                    <div class="sc_navigation hidden-sm hidden-xs">
                        <nav id="primary-nav" class="dropdown nav_left_margin">
                            <ul class="dropdown menu navigation cart_dropdown_wrapper">
                                ...
                                <li class="caret_btn">
                                    <a href="index.html#"><i class="fa fa-shopping-basket"></i><span>2</span></a>
                                    <ul>
                                        <li>
                                            <div class="cc_cart_wrapper1 menu-button">
                                                ...
                                                <div class="cc_cart_cont_wrapper">
                                                    <h4><a href="index.html#">put a title here</a></h4>
                                                    <p>1 <span> $145 </span> </p>
                                        ...
                                        <li>
                                            ...
                                            <div class="cart_checkout_btn">
                                                ...
                                                <a href="index.html#!" class="waves-effect waves-light waves-ripple">checkout</a>
                            ...
                            <div class="header_right_main_wrapper">
                                <div class="search-wrapper">
                                    <div class="et_navbar_search_wrapper hidden-xs">
                                        <div class="et_search_bar" id="search_button">
                                            <a href="index.html#"><i class="fa fa-search waves-effect waves-light" aria-hidden="true"></i></a>
                                        </div>
                                    ...
                                    <ul class="tc_login_btn_wrapper">
                                        <li class="dropdown tc_login_btn">
                                            ...
                                            <ul class="dropdown-menu tc_menu_fixed_border">
                                                <li class="dropdown_hover"><a href="index.html#">FAQ's</a></li>
                                                <li class="dropdown_hover"><a href="index.html#">Track Order</a></li>
                                                <li class="dropdown_hover"><a href="index.html#">Register</a></li>
                                                <li class="dropdown_hover"><a href="index.html#">Login</a></li>
                                                <li class="dropdown_hover hidden-lg"><a href="index.html#">Free Quote</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </div>
                                <div class="header_btn">
                                    <ul>
                                        <li>
                                            <a href="index.html#!" class="waves-effect waves-light waves-ripple">free quote</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
